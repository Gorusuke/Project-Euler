function largestProductinaSeries(n) {
  ...
  let largestSerieMultiply = 0
  for (let i = 0; i < thousandDigits.length; i++) {
    const numbers = thousandDigits.slice(i, n + i);
    const numbersMultiply = numbers.reduce((a, b) => a * b, 1)
    largestSerieMultiply = Math.max(numbersMultiply, largestSerieMultiply)
  }

  return largestSerieMultiply
}

console.log(largestProductinaSeries(4)) // 5842
console.log(largestProductinaSeries(3)) // 648
