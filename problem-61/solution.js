...
console.log(cyclicalFigurateNums(3)) // 19291
console.log(cyclicalFigurateNums(4)) // 28684
console.log(cyclicalFigurateNums(5)) // 76255
console.log(cyclicalFigurateNums(6)) // 28684
